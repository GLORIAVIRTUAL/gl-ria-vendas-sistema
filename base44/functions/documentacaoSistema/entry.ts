 ...
 * 
 * ESTE ARQUIVO CONTÉM TODA A DOCUMENTAÇÃO DO SISTEMA
 * Abra este arquivo para ler a documentação completa
 * 
 * ═══════════════════════════════════════════════════════════════════════════════════════
 * 📦 O QUE ESTÁ INCLUÍDO:
 * ═══════════════════════════════════════════════════════════════════════════════════════
 ...
 *   "system_prompt": "Você é GLÓRIA, assistente virtual...",
 *   "ai_model": "gpt-4o",
 *   "is_active": true,
 ...
 * Resultado: 4 páginas aparecerão no sidebar
 * 
 ...
 * Configure Verify Token: o mesmo que META_VERIFY_TOKEN
 ...
 * ═══════════════════════════════════════════════════════════════════════════════════════
 * 
 * ✓ ESTE É UM SISTEMA COMPLETO: Todos os componentes trabalham juntos
 * ✓ ÚLTIMA ATUALIZAÇÃO: 09/01/2026 com todas as features
 * ✓ REQUER OPENAI_API_KEY: Para transcrição e processamento de IA
