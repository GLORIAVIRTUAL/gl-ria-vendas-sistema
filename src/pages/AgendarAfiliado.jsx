...
export default function AgendarAfiliado() {
  ...
  const createMutation = useMutation({
    mutationFn: async (data) => {
      ...
      setErro(null);
      setProcessingStepMessage("Processando...");
      ...
      try {
        ...
        setProcessingStepMessage("Criando evento no Google Calendar...");
        ...
        setProcessingStepMessage("Registrando agendamento...");
        ...
        setProcessingStepMessage("Criando Lead no CRM...");
        ...
        setProcessingStepMessage("Criando reunião...");
      }
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['agendamentos'] });
      queryClient.invalidateQueries({ queryKey: ['leads'] });
      navigate(createPageUrl("DashboardAfiliado"));
    },
    onError: (error) => {
    ...
    <div className="p-4 md:p-8 min-h-screen">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-4 mb-8">
          <Link to={createPageUrl("DashboardAfiliado")}>
