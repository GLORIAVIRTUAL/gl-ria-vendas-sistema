...
export default function EditCompromissoDialog({ compromisso, open, onOpenChange, onSave, isSaving }) {
  ...
  useEffect(() => {
    if (compromisso) {
      setFormData({
        ...
        notificar_whatsapp: compromisso.notificar_whatsapp || false,
        telefone_notificacao: compromisso.telefone_notificacao || "",
        minutos_antes_notificar: compromisso.minutos_antes_notificar || 30,
        cor: compromisso.cor || "#3b82f6",
        recorrente: compromisso.recorrente || false,
        tipo_recorrencia: compromisso.tipo_recorrencia || "Nenhuma"
      });
    }
  }, [compromisso]);
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl">Editar Compromisso</DialogTitle>
        </DialogHeader>
            ...
            {formData.recorrente && (
              <div className="pl-6">
                ...
                <p className="text-xs text-purple-600 mt-2">
                  ℹ️ Alterar aqui não afeta compromissos já criados
                </p>
              </div>
            )}
          </div>
