  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        ...
        isOutbound
          ? "[transform:translateZ(16px)_rotateY(-1deg)_rotateX(0.5deg)]"
          : "[transform:translateZ(16px)_rotateY(1deg)_rotateX(0.5deg)]"
      )}>
        {isOutbound && (
          <div className={cn(
